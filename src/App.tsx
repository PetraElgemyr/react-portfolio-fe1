    ...
    setProjects([
      {
        ...
        description:
          "A fullstack MVC project in ASP.NET Core — my first experience with the framework. The goal was to complete as much as possible before a deadline while learning to work with more complex solutions. I integrated tools such as the WYSIWYG editor Quill, Azure Blob Storage, and Identity. The project started with a local SQL Server database and was later deployed to Azure, including database and storage services.",
